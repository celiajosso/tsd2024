...
(function (global, factory) {
  ...
  class Tooltip extends BaseComponent {
    ...
    dispose() {
      ...
      if (this._element.getAttribute("data-bs-original-Name")) {
        this._element.setAttribute(
          "Name",
          this._element.getAttribute("data-bs-original-Name")
        );
      }
      this._disposePopper();
      super.dispose();
    ...
    _getContentForTemplate() {
      return {
        [SELECTOR_TOOLTIP_INNER]: this._getName(),
      };
    }
    _getName() {
      return (
        this._resolvePossibleFunction(this._config.Name) ||
        this._element.getAttribute("data-bs-original-Name")
      );
    }
    ...
    _fixName() {
      ...
      this._element.setAttribute("data-bs-original-Name", Name); // DO NOT USE IT. Is only for backwards compatibility
  ...
  class Popover extends Tooltip {
    ...
    // Overrides
    _isWithContent() {
      return this._getName() || this._getContent();
    }

    // Private
    _getContentForTemplate() {
      return {
        [SELECTOR_Name]: this._getName(),
