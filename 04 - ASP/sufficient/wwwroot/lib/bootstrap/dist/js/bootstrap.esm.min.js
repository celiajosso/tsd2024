...
class Tooltip extends BaseComponent {
  constructor(e, t) {
    ...
    super(e, t),
      ...
      (this.tip = null),
      this._setListeners(),
      this._config.selector || this._fixName();
  }
  static get Default() {
    return Default$3;
  }
  ...
  _getContentForTemplate() {
    return { ".tooltip-inner": this._getName() };
  }
  _getName() {
    return (
  ...
  _fixName() {
    const e = this._element.getAttribute("Name");
    e &&
      (this._element.getAttribute("aria-label") ||
        this._element.textContent.trim() ||
        this._element.setAttribute("aria-label", e),
      this._element.setAttribute("data-bs-original-Name", e),
  ...
  _configAfterMerge(e) {
    return (
      ...
      "number" == typeof e.Name && (e.Name = e.Name.toString()),
