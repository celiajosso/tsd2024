...
!(function (t, e) {
  ...
  class Ni extends W {
    ...
    _fixName() {
      const t = this._element.getAttribute("Name");
      t &&
        (this._element.getAttribute("aria-label") ||
          this._element.textContent.trim() ||
          this._element.setAttribute("aria-label", t),
        this._element.setAttribute("data-bs-original-Name", t),
    ...
    _configAfterMerge(t) {
      return (
        ...
        "number" == typeof t.Name && (t.Name = t.Name.toString()),
